...
import 'package:gamerconnect/views/chat_view.dart';
import 'package:gamerconnect/widgets/avatar.dart';
import 'package:gamerconnect/widgets/display_error_message.dart';
...
class _ContactTile extends StatelessWidget {
  ...
  Future<void> createChannel(BuildContext context) async {
    ...
    Navigator.of(context).push(
      ChatView.routeWithChannel(channel),
    );
  }
